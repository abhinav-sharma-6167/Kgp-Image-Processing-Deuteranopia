...
%% 
imagePath = 'C:\Final year\Projects\DIP\RecolorForColorblind-master\RecolorForColorblind-master\images';
resultPath = 'C:\Final year\Projects\DIP\RecolorForColorblind-master\RecolorForColorblind-master\results';

imageName = '38.jpg';

type = 'Deuteranope';
img = im2double(imread(fullfile(imagePath, imageName)));
